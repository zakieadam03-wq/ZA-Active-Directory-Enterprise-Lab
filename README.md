...
In the images below some screenshots will display the following:
a successful "ping" from the client machine to server machine (ran the cmd prompt as an administrator) showcasing the client VM being in the server VM,
a screenshot showing the client machine being locked out of the cmd prompt program,
a screenshot showing John Doe as part of the domain and a screenshot showing the user John Doe.
